...
-- 1. bulk insert is a T-sql command used to import a large volume of data from a file into a Sql server table efficiently. 
...
--2. CSV(comma-separated values)
  ...
  -- XML( eXtensible Markup language)
   ...
   --5. Null means that the field can store no value or "unknown"
...
from Products 
16. -- foreign key provides the connection between the column of another table. 
